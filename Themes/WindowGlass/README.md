...
```json
{
  ...
  "styleConstants[5]": "ClockBG=<WindhawkBlur BlurAmount=\"5\" TintColor=\"{ThemeResource SystemAccentColor}\" TintOpacity=\"0.7\" />",
  "styleConstants[6]": "BorderThickness=0.3,1,0.3,1",
  "styleConstants[7]": "CornerRadius=35",
  "styleConstants[8]": "SearchBoxRadius=20",
  "styleConstants[9]": "ElementBG=<WindhawkBlur BlurAmount=\"20\" TintColor=\"{ThemeResource SystemChromeMediumColor}\" TintOpacity=\"0.3\" />",
  ...
  "controlStyles[2].styles[1]": "RenderTransform:=<TranslateTransform X=\"0\" Y=\"-110\" />",
  ...
  "controlStyles[11].target": "Windows.UI.Xaml.Controls.Border#StartDropShadow",
  "controlStyles[11].styles[0]": "Visibility=1",
  "controlStyles[12].target": "Windows.UI.Xaml.Controls.Border#DropShadowDismissTarget",
  "controlStyles[12].styles[0]": "Background:=$Glass",
  "controlStyles[12].styles[1]": "BorderBrush:=$BorderBrush",
  ...
  "controlStyles[13].styles[4]": "Margin=0,60,0,10",
  "controlStyles[13].styles[5]": "Visibility=1",
  "controlStyles[14].target": "Windows.UI.Xaml.Controls.Border#AcrylicOverlay",
  "controlStyles[14].styles[0]": "Visibility=1",
  "controlStyles[15].target": "StartDocked.SearchBoxToggleButton#StartMenuSearchBox",
  "controlStyles[15].styles[0]": "Width=650",
  "controlStyles[15].styles[1]": "Height=50",
  "controlStyles[15].styles[2]": "Margin=0,-15,0,0",
  "controlStyles[16].target": "StartDocked.SearchBoxToggleButton#StartMenuSearchBox > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.Border#BorderElement",
  "controlStyles[16].styles[0]": "Background:=$ElementBG",
  "controlStyles[16].styles[1]": "BorderBrush:=$ElementBorderBrush",
  ...
  "controlStyles[17].target": "StartDocked.SearchBoxToggleButton#StartMenuSearchBox > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.ContentPresenter#ContentPresenter > Windows.UI.Xaml.Controls.TextBlock#PlaceholderText",
  "controlStyles[17].styles[0]": "Text=Search This Precision",
  "controlStyles[18].target": "Windows.UI.Xaml.Controls.Grid#TopLevelRoot > Windows.UI.Xaml.Controls.Grid",
  "controlStyles[18].styles[0]": "Visibility=1",
  "controlStyles[19].target": "StartDocked.NavigationPaneView#NavigationPane",
  "controlStyles[19].styles[0]": "Width=550",
  "controlStyles[19].styles[1]": "RenderTransform:=<TranslateTransform X=\"0\" Y=\"10\" />",
  "controlStyles[20].target": "Windows.UI.Xaml.Controls.Button#ShowAllAppsButton",
  "controlStyles[20].styles[0]": "Visibility=1",
  "controlStyles[21].target": "StartMenu.PinnedList#StartMenuPinnedList",
  "controlStyles[21].styles[0]": "Margin=0",
  "controlStyles[21].styles[1]": "Height=280",
  "controlStyles[22].target": "StartMenu.PinnedList#StartMenuPinnedList > Windows.UI.Xaml.Controls.Grid#Root",
  "controlStyles[22].styles[0]": "Background:=$ElementBG",
  "controlStyles[22].styles[1]": "BorderBrush:=$ElementBorderBrush",
  "controlStyles[22].styles[2]": "BorderThickness=$ElementBorderThickness",
  "controlStyles[22].styles[3]": "CornerRadius=$ElementCornerRadius",
  "controlStyles[23].target": "Windows.UI.Xaml.Controls.Grid#UndockedRoot",
  "controlStyles[23].styles[0]": "Visibility=0",
  "controlStyles[23].styles[1]": "Width=650",
  "controlStyles[23].styles[2]": "Margin=0,-130,0,230",
  "controlStyles[23].styles[3]": "Canvas.ZIndex=1",
  "controlStyles[23].styles[4]": "MaxHeight:=340",
  "controlStyles[24].target": "Windows.UI.Xaml.Controls.Grid#AllAppsRoot",
  "controlStyles[24].styles[0]": "Visibility=0",
  "controlStyles[24].styles[1]": "Margin=-1600,190,115,-100",
  "controlStyles[24].styles[2]": "MaxHeight=330",
  "controlStyles[24].styles[3]": "Background:=$ElementBG",
  "controlStyles[24].styles[4]": "CornerRadius=$ElementCornerRadius",
  "controlStyles[24].styles[5]": "Width=650",
  "controlStyles[24].styles[6]": "BorderBrush:=$ElementBorderBrush",
  "controlStyles[24].styles[7]": "BorderThickness=$ElementBorderThickness",
  "controlStyles[25].target": "Windows.UI.Xaml.Controls.Button#CloseAllAppsButton",
  "controlStyles[25].styles[0]": "Visibility=1",
  "controlStyles[26].target": "Windows.UI.Xaml.Controls.TextBlock#AllAppsHeading",
  "controlStyles[26].styles[0]": "Visibility=1",
  "controlStyles[27].target": "StartDocked.AllAppsPane#AllAppsPanel",
  "controlStyles[27].styles[0]": "Margin=-20,-20,20,20",
  "// Phone Link Panel //": "",
  "controlStyles[28].target": "StartDocked.StartMenuCompanion#RightCompanion > Windows.UI.Xaml.Controls.Grid#CompanionRoot > Windows.UI.Xaml.Controls.Border#AcrylicBorder",
  ...
  "controlStyles[29].target": "Windows.UI.Xaml.Controls.Grid#CompanionRoot > Windows.UI.Xaml.Controls.Grid#MainContent > Windows.UI.Xaml.Controls.Grid#ActionsBar > Windows.UI.Xaml.Controls.Button#PrimaryActionBarButton > Windows.UI.Xaml.Controls.ContentPresenter#ContentPresenter",
  ...
  "controlStyles[30].target": "Windows.UI.Xaml.Controls.Grid#ActionsBar > Windows.UI.Xaml.Controls.Button#ActionBarOverflowButton",
  ...
  "controlStyles[30].styles[4]": "Height=40",
  "controlStyles[31].target": "StartDocked.StartMenuCompanion#RightCompanion > Windows.UI.Xaml.Controls.Grid#CompanionRoot",
  "controlStyles[31].styles[0]": "Height=730",
  "controlStyles[31].styles[1]": "Margin=0,-10,0,-10",
  "controlStyles[31].styles[2]": "Padding=10,0,-2,0",
  "// Flyouts and Menus //": "",
  "controlStyles[32].target": "Windows.UI.Xaml.Controls.Border#OverflowFlyoutBackgroundBorder",
  "controlStyles[32].styles[0]": "Background:=$Glass",
  ...
  "controlStyles[33].target": "Windows.UI.Xaml.Controls.MenuFlyoutPresenter > Windows.UI.Xaml.Controls.Border",
  "controlStyles[33].styles[0]": "Background:=$Glass",
  ...
  "controlStyles[34].target": "Windows.UI.Xaml.Controls.Grid#HoverFlyoutGrid > Windows.UI.Xaml.Controls.Border#HoverFlyoutBackground",
  ...
  "// Search Menu //": "",
  "controlStyles[35].target": "Cortana.UI.Views.TaskbarSearchPage > Windows.UI.Xaml.Controls.Grid#RootGrid > Windows.UI.Xaml.Controls.Grid#OuterBorderGrid",
  ...
  "controlStyles[36].target": "Windows.UI.Xaml.Controls.Border#LayerBorder",
  "controlStyles[36].styles[0]": "Visibility=1",
  "controlStyles[37].target": "Windows.UI.Xaml.Controls.Border#AccentLayerBorder",
  "controlStyles[37].styles[0]": "Visibility=1",
  "controlStyles[38].target": "Windows.UI.Xaml.Controls.Border#dropshadow",
  "controlStyles[38].styles[0]": "Visibility=1",
  "controlStyles[39].target": "Windows.UI.Xaml.Controls.Border#AppBorder",
  ...
  "controlStyles[40].styles[3]": "CornerRadius=15",
  "// Folder //": "",
  "controlStyles[41].target": "StartMenu.FolderModal#StartFolderModal > Windows.UI.Xaml.Controls.Grid#Root",
  "controlStyles[41].styles[0]": "MaxHeight:=420",
  "controlStyles[41].styles[1]": "MaxWidth:=420",
  "controlStyles[41].styles[2]": "Height=Auto",
  "controlStyles[41].styles[3]": "Width=Auto",
  "controlStyles[42].target": "StartMenu.FolderModal#StartFolderModal > Windows.UI.Xaml.Controls.Grid#Root > Windows.UI.Xaml.Controls.ContentControl#ContentControl > Windows.UI.Xaml.Controls.ContentPresenter > StartMenu.UniversalTileContainer#UniversalTileContainer > Windows.UI.Xaml.Controls.Grid#GridViewContainer",
  "controlStyles[42].styles[0]": "Width=400",
  "controlStyles[42].styles[1]": "Height=400",
  "controlStyles[43].target": "Windows.UI.Xaml.Controls.Grid#Root > Windows.UI.Xaml.Controls.Border",
  ...
  "controlStyles[44].target": "StartMenu.ExpandedFolderList",
  "controlStyles[44].styles[0]": "Margin=0,30,0,-120",
  "// New Start Menu//": "",
  "// Start Menu//": "",
  "controlStyles[45].target": "Windows.UI.Xaml.Controls.Grid#MainMenu > Windows.UI.Xaml.Controls.Border#AcrylicBorder",
  "controlStyles[45].styles[0]": "Visibility=1",
  "controlStyles[46].target": "StartMenu.SearchBoxToggleButton#SearchBoxToggleButton",
  "controlStyles[46].styles[0]": "Height=50",
  "controlStyles[46].styles[1]": "Margin=-20,20,-20,-20",
  "controlStyles[46].styles[2]": "Width=400",
  "controlStyles[47].target": "StartMenu.SearchBoxToggleButton#SearchBoxToggleButton > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.Border#BorderElement",
  ...
  "controlStyles[48].target": "Windows.UI.Xaml.Controls.Primitives.ToggleButton#ShowHideCompanion",
  "controlStyles[48].styles[0]": "Margin=-50,40,0,0",
  "controlStyles[49].target": "Windows.UI.Xaml.Controls.TextBlock#PinnedListHeaderText",
  "controlStyles[49].styles[0]": "Visibility=1",
  "controlStyles[50].target": "Windows.UI.Xaml.Controls.Grid#AllListHeading",
  "controlStyles[50].styles[0]": "Margin=0,-10,0,0",
  "controlStyles[51].target": "Windows.UI.Xaml.Controls.Grid#AllListHeading > Windows.UI.Xaml.Controls.TextBlock#AllListHeadingText",
  "controlStyles[51].styles[0]": "Visibility=1",
  "controlStyles[52].target": "StartMenu.CategoryControl > Windows.UI.Xaml.Controls.Grid#RootGrid > Windows.UI.Xaml.Controls.Border ",
  ...
  "controlStyles[52].styles[3]": "CornerRadius=$ElementCornerRadius",
  "// Start menu Width//": "",
  "controlStyles[53].target": "Windows.UI.Xaml.Controls.Grid#MainMenu",
  "controlStyles[53].styles[0]": "Width=460",
  "// Pinned Apps//": "",
  ...
  "controlStyles[56].target": "StartMenu.StartMenuCompanion#RightCompanion",
  "controlStyles[56].styles[0]": "Height=810",
  "controlStyles[56].styles[1]": "Margin=15,0,30,0",
  "// Phone Link Panel//": "",
  "controlStyles[57].target": "Windows.UI.Xaml.Controls.Grid#CompanionRoot > Windows.UI.Xaml.Controls.Border#AcrylicBorder",
  "controlStyles[57].styles[0]": "Background:=$ElementBG",
  "controlStyles[57].styles[1]": "BorderBrush:=$ElementBorderBrush",
  "controlStyles[57].styles[2]": "BorderThickness=$ElementBorderThickness",
  ...
  "controlStyles[61].styles[0]": "Background:=Transparent",
  ...
  "controlStyles[63].styles[0]": "CornerRadius=$HoverCornerRadius",
  "controlStyles[63].styles[1]": "Margin=-12,0,12,0",
